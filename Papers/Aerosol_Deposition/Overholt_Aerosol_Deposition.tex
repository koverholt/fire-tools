...
To assess the impact of different grid resolutions, multiple simluations were run with grid cell sizes of 0.5~cm, 0.75~cm, 1~cm, and 2~cm. The aerosol deposition rates for each case are shown in Table~\ref{tab:Grid_Sensitivity}.
...
\begin{tabular}{ccccc}
\hline\noalign{\smallskip}
Test      &  Air     &  Particle  &  Grid Cell  &  Aerosol Deposition  \\
Number    &  Speed   &  Diameter  &  Size       &  Velocity            \\
          &  (m/s)   &  ($\mu$m)  &  (cm)       &  (m/s)               \\
\noalign{\smallskip}\hline\noalign{\smallskip}
1         &  2.2     &  1.0       &  0.5        &  XX                  \\
1         &  2.2     &  1.0       &  0.75       &  XX                  \\
...
To assess the impact of different inlet aerosol concentrations, multiple simluations were run with inlet aerosol concentrations of 50~mg/m$^3$, 100~mg/m$^3$, 200~mg/m$^3$, and 1000~mg/m$^3$. The aerosol deposition rates for each case are shown in Table~\ref{tab:Concentration_Sensitivity}.
...
\begin{tabular}{ccccc}
\hline\noalign{\smallskip}
Test      &  Air     &  Particle  &  Aerosol Inlet  &  Aerosol Deposition  \\
Number    &  Speed   &  Diameter  &  Concentration  &  Velocity            \\
          &  (m/s)   &  ($\mu$m)  &  (mg/m$^3$)     &  (m/s)               \\
\noalign{\smallskip}\hline\noalign{\smallskip}
1         &  2.2     &  1.0       &  50             &  XX                  \\
1         &  2.2     &  1.0       &  100            &  XX                  \\
